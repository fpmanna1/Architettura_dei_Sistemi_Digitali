...
HD_PWD='C:/Users/plett/OneDrive/Desktop/Projects_ASDI/Capitolo_1_Reti_Combinatorie_Elementari/2_1_Encoder/2_1_Encoder.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_bcd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source enc_bcd.tcl
