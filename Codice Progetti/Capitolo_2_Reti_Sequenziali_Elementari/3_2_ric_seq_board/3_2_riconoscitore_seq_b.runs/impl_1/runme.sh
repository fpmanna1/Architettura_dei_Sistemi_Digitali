...
HD_PWD='C:/Users/claud/VivadoProjects/3_2_riconoscitore_seq_b/3_2_riconoscitore_seq_b.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ric_seq_onboard.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ric_seq_onboard.tcl -notrace
