...
HD_PWD='C:/Users/plett/OneDrive/Desktop/Projects_ASDI/Capitolo_1_Reti_Combinatorie_Elementari/2_1_Encoder/2_1_Encoder.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log enc_bcd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source enc_bcd.tcl -notrace
