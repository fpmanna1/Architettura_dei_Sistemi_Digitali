...
HD_PWD='C:/Users/claud/VivadoProjects/3_2_riconoscitore_seq_b/3_2_riconoscitore_seq_b.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ric_seq_onboard.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ric_seq_onboard.tcl
