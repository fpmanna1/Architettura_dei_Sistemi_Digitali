...
HD_PWD='C:/Users/plett/OneDrive/Desktop/Projects_ASDI/Capitolo_2_Reti_Sequenziali_Elementari/ric_seq/ric_seq.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ric_seq.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ric_seq.tcl
